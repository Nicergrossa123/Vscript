...
namespace Nexus.Module.Stadthalle
{
    public class NameChangeFunctions
    {
        public static void DoNameChange(DbPlayer dbPlayer, String newName, bool marriage)
        {
            ...
            dbPlayer.SendNewNotification($"Du hast deinen Namen erfolgreich zu {newName} geändert! Bitte beende nun das Spiel und trag deinen neuen Namen in den RageMP-Launcher ein!", PlayerNotification.NotificationType.ADMIN, duration: 30000);
