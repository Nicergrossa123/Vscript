...
namespace Nexus.Module.Players.Events.EasterEvent
{
            ...
            if (easterRabbit != null)
            {
                ...
                else
                {
                    ...
                    if(dbPlayer.Container.CanInventoryItemAdded(EasterEggId))
                    {
                        ...
                        dbPlayer.SendNewNotification($"Du hast ein {ItemModelModule.Instance.Get(EasterEggId).Name} bekommen! Frohe Ostern wünscht Nexus.");
