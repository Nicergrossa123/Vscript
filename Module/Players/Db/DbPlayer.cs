...
using Nexus.Module.Weapons;
using Nexus.Module.Voice;
using System.Threading.Tasks;
using Nexus.Module.Telefon.App.Settings;
    ...
    public class DbPlayer
    {
       ...
       // public Nutrition Nutrition { get; set; }
        ...
        public void WarpOutOfVehicle(bool checkAC = false)
        {
            ...
            if (checkAC)
            {
                NAPI.Task.Run(() => { if (Player.IsInVehicle) { Player.Kick(); } }, 5000);
            }
        }
