...
namespace Nexus.Module.Configurations
{
    public class DefaultConfiguration
    {
        ...
        // Liebe Grüße von Papa Paco
        #region debug  
        public string GetMySqlConnection()
        {
            return Ptr
                ? "server='localhost'; uid='root'; pwd=''; database='nexus';max pool size=999;SslMode=none;"
                : "server='localhost'; uid='root'; pwd=''; database='nexus';max pool size=999;SslMode=none;";
        }
        #endregion
        ...
        {
            return
          "server='176.96.136.51'; uid='" + "Nexusto1_wcf" + "'; pwd='" + "Nv5_08wd" + "'; database='Nexusto1_wcf';max pool size=999;SslMode=none;";
        }

        public string GetMySqlConnectionWhitelist()
        {
            return
             "";   //"server='localhost'; uid='" + mysql_user + "'; pwd='" + mysql_pw + "'; database='venom';max pool size=999;SslMode=none;";
        }
