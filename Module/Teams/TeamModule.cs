...
using Nexus.Module.Teams.Spawn;

namespace Nexus.Module.Teams
{
    public sealed class TeamModule : SqlModule<TeamModule, Team, uint>
    {
        ...
        {
            return Id == (int)teams.TEAM_YAKUZA || Id ==(int)teams.TEAM_LCN;
        }
        public bool IsWeedTeamId(uint Id)
        {
            return Id == (int)teams.TEAM_BALLAS || Id == (int)teams.TEAM_GROVE;
        }
