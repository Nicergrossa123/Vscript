...
using Nexus.Module.Heist.Planning;
...
using Nexus.Module.Workstation;

namespace Nexus.Module.Teams.Shelter
{
            ...
            public bool OnSelect(int index, DbPlayer dbPlayer)
            {
                ...
                else if (dbPlayer.Team.IsGangster)
                {
                    ...
                    else if (index == 4)
                    {
                        ...
                        {
                            Module.Menu.MenuManager.Instance.Build(Nexus.Module.Menu.PlayerMenu.PistoleCreateMenu, dbPlayer).Show(dbPlayer);
                            return false;
                        }
