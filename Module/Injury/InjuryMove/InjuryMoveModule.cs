...
using System.Linq;
using System.Text;
using Nexus.Module.Injury.InjuryMove.Menu;
using Nexus.Module.Menu;
using Nexus.Module.Players;
using Nexus.Module.Players.Db;

namespace Nexus.Module.Injury.InjuryMove
{
                ...
                if(dbPlayer.IsInDuty())
                {
                    ...
                    if (injuryMovePoint != null)
                    {
                        ...
                        if (injuredPlayer != null && injuredPlayer.IsValid())
                        {
                            ...
                            Module.Menu.MenuManager.Instance.Build(Nexus.Module.Menu.PlayerMenu.InjuryMoveMenu, dbPlayer).Show(dbPlayer);
                            return true;
                        }
                    }
                }
