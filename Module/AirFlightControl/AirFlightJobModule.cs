...
namespace Nexus.Module.AirFlightControl
{
    public class AirFlightJobModule : Module<AirFlightJobModule>
    {
        ...
        public override bool OnKeyPressed(DbPlayer dbPlayer, Key key)
        {
            ...
            Module.Menu.MenuManager.Instance.Build(Nexus.Module.Menu.PlayerMenu.AirFlightJobStartMenu, dbPlayer).Show(dbPlayer);
            return true;
        }
