    ...
    public sealed class SecureEventThread
    {
        ...
        public void Init()
        {
            ...
            foreach (var l_SecureEvent in l_InitHandler.SecureEventMethods)
            {
                ...
                DiscordHandler.SendMessage($"bruder das ist nur ein test von daddy Paco Started Thread for Secure-Event: {l_SecureEvent.Name} ({m_Threads[l_SecureEvent.Name].ManagedThreadId}");
            }
        }
